...
export function renderHeader(container, state) {
  ...
  if (cache && cache.routeName === routeName && cache.sessionLabel === sessionLabel && cache.canOpenDashboard === canOpenDashboard && cache.isRep === isRep && cache.tierName === (tier?.tier_name || '')) {
