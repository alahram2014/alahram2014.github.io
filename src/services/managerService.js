...
async function loadManagerCustomers(api, ownerId, session = {}) {
  ...
  return list.filter((row) => matchesAnyOwner(row, ownerId, ['owner_id', 'owner_user_id', 'sales_rep_id', 'created_by_rep_id', 'created_by']));
}
...
async function loadManagerOrders(api, ownerId, customerIds = [], session = {}) {
  ...
  return list.filter((row) => {
    const ownerMatch = matchesAnyOwner(row, ownerId, ['owner_id', 'sales_rep_id', 'rep_id', 'user_id']);
