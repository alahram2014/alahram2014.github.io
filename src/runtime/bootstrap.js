...
function scheduleHydration(level, fn) {
...
function unitBadge(code) {
  var labels = { box: 'كرتونة', piece: 'قطعة', pack: 'حزمة', unit: 'وحدة', bundle: 'ربطة', bottle: 'زجاجة', tin: 'علبة', pouch: 'كيس' };
