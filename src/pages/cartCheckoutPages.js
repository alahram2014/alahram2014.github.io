...
export function renderInvoicePage(state) {
  ...
  for (const group of groupedItems) {
    ...
    tableBody += `<tr class="invoice-detail__group-header"><td colspan="5"><span class="invoice-detail__group-line"></span><strong>${dom.escape(companyName)}</strong></td></tr>`;
      ...
      <div class="invoice-detail__header">
        ...
        <div class="invoice-detail__header-meta">
          <div class="invoice-detail__meta-block">
            ...
            <strong>${dom.escape(String(invoiceNum))}</strong>
          </div>
          <div class="invoice-detail__meta-block">
            <span>التاريخ</span>
            <strong>${dom.escape(dateStr)}</strong>
          </div>
          <div class="invoice-detail__meta-block">
            <span>الوقت</span>
            <strong>${dom.escape(timeStr)}</strong>
          </div>
        </div>
      </div>
